...
# CCPP prebuild config for PHYSICS 
...
VARIABLE_DEFINITION_FILES = [
    'phystest/src/phystest_var_defs.f90',
    ]
...
SCHEME_FILES = [
    'SHARED_physics/src/kessler.f90',
    ]

# Auto-generated makefile/cmakefile snippets that contain all schemes
SCHEMES_MAKEFILE = 'SHARED_physics/CCPP_SCHEMES.mk'
SCHEMES_CMAKEFILE = 'SHARED_physics/CCPP_SCHEMES.cmake'

# CCPP host cap in which to insert the ccpp_field_add statements;
# determines the directory to place ccpp_{modules,fields}.inc
TARGET_FILES = [
    'phystest/src/phystest.f90',
    ]

# Auto-generated makefile/cmakefile snippets that contain all caps
CAPS_MAKEFILE = 'SHARED_physics/CCPP_CAPS.mk'
CAPS_CMAKEFILE = 'SHARED_physics/CCPP_CAPS.cmake'

# Directory where to put all auto-generated physics caps
CAPS_DIR = 'SHARED_physics/physics'
...
HTML_VARTABLE_FILE = 'SHARED_physics/CCPP_VARIABLES_PHYSICS.html'

# LaTeX document containing the provided vs requested CCPP variables
LATEX_VARTABLE_FILE = 'ccpp-framework/doc/DevelopersGuide/CCPP_VARIABLES_PHYSICS.tex'
...
# in the case of PHYSICS, this is a vector with loop index i
